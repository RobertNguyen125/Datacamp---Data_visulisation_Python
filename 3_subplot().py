...
plt.tight_layout()
plt.show()
plt.savefig('/Users/apple/desktop/dataVisualisation/1_customisingPlots/3_computerSciencevsPhysics.png')
...
plt.tight_layout()
plt.show()
plt.savefig('/Users/apple/desktop/dataVisualisation/1_customisingPlots/3_subplot2.png')
